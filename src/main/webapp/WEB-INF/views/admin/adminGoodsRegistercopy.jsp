...
<script>
	function fCheck(){
		let fName= myform.fName22.value;
		alert(fName);
		/* myform.submit(); */
	}
	...
	<div>
		<form name="myform" method="post" enctype="multipart/form-data">
			<div id="memberInfo" class="flexDiv">
				<div class="bigText"><h1><strong>상품 등록</strong></h1></div>
				<div class="col">
				...
				<div class="col">
					...
					<div><input type="text" name="price" id="price" class="inputText"></div>
				</div>
				<div class="col">
			...
			<%-- <div class="row">
				<div class="col-sm-4">첨부파일</div>
				<div class="col-sm-8"><input type="file" name="file" id="file" class="form-control-file border"></div>
			</div>
			<hr>
			<div class="row">
				<div class="col-sm-4">브랜드 선택</div>
				<div class="col-sm-8">
			...
			<hr>
			<div class="row">
				<div class="col-sm-4">제품가격</div>
				<div class="col-sm-8"><input type="text" name="price" id="price"></div>
			</div>
			<hr>
			<div class="row">
				<div class="col">대분류 선택</div>
				<div class="col">
				...
				<div class="col">중분류 선택</div>
				<div class="col">
					<select id="subCategory" name="subCategory">

					</select>
				</div>
				<div class="col">소분류 선택</div>
				<div class="col">
					<select id="secondCategory" name="secondCatagory_Idx">
